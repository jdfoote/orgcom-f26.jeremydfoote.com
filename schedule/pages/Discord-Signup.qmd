...
---
We will be using [Discord](https://en.wikipedia.org/wiki/Discord) for
...
Click the Firework/Network icon (🎆) and you should then see the COM 324
category on the left side.

A few years ago I made a video to walk you through how to do this if you get stuck. I think the process is still basically the same.
